...
export function App() {
  ...
  const loadAllTransactions = useCallback(async () => {
    ...
    // bug 5: finish loading after employees are loaded
    // rather than after transactions are loaded
    setIsLoading(false)
      ...
      <main className="MainContainer">
        ...
        <InputSelect<Employee>
          ...
          onChange={async (newValue) => {
            // bug 3: if the value is null (at start) or empty employee ("All  Employees") load all transactions
            // otherwise load specific employee transactions
        ...
        <div className="RampGrid">
          ...
          {/* bug 6: toggle view based off if a next page exists
